...
## Adding a new plugin
To install a new plugin you can use the `nx add` command. Here's an example of adding the relevant plugin
...
## Add new projects managed by nx
