"""Logging configuration for the balance-driver package.

Mirrors the opentrons-driver logging pattern: optional file output to a
``logs/`` folder alongside console output.  Call once at the start of your
script before creating any :class:`~balance_driver.machines.balance.Balance`
instances.
...
Example::
    ...
    setup_logging(enable_file_logging=True, log_level=logging.DEBUG, log_file_name="balance_experiment")
"""
...
def setup_logging(
    ...
    """Configure logging for the balance-driver package.
